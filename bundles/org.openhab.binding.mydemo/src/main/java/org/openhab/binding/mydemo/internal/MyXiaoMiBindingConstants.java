...
/**
 * The {@link MyXiaoMiBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author zaoweiceng - Initial contribution
 */
@NonNullByDefault
public class MyXiaoMiBindingConstants {

    public static final String BINDING_ID = "myxiaomi";
