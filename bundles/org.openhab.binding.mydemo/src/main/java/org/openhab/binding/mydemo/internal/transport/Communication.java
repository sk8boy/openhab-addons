 ...
 */
package org.openhab.binding.mydemo.internal.transport;
...
import org.openhab.binding.mydemo.internal.Message;
import org.openhab.binding.mydemo.internal.MiIoCrypto;
import org.openhab.binding.mydemo.internal.MyXiaoMiBindingConstants;
    ...
    private synchronized byte[] comms(byte[] msg, String ip) throws IOException {
        ...
        try {
            ...
            DatagramPacket sendPacket = new DatagramPacket(sendData, sendData.length, ipAddress,
                    MyXiaoMiBindingConstants.PORT);
            socket.send(sendPacket);
            sendPacket.setData(new byte[MSG_BUFFER_SIZE]);
            socket.receive(receive);
            byte[] responce = Arrays.copyOfRange(receive.getData(), receive.getOffset(),
                    receive.getOffset() + receive.getLength());
            return responce;
