...
public class MiIoCrypto {
    ...
    public static byte[] encrypt(byte[] text, byte[] token) throws NoSuchAlgorithmException, IllegalBlockSizeException,
    ...
    public static byte[] decrypt(byte[] cipherText, byte[] token)
